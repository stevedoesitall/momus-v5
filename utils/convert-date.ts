const convertDate = (date: Date | string): string => {
	const dateLocaleString: string = new Date(date).toLocaleString("en-US", { timeZone: "America/New_York" });
	const dateSubstring: string = dateLocaleString.substring(0, dateLocaleString.indexOf(","));
